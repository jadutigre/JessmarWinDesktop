...
class FormVendedores extends StatefulWidget {
  Vendedor vendedor;
  FormVendedores({Key key, @required this.vendedor}) : super(key: key);
  _FormVendedoresState createState() => _FormVendedoresState();
}


class _FormVendedoresState extends State<FormVendedores> {
  ...
  Future<Map<String,dynamic>> _getData() async {
    ...
    Vendedor vendedor = widget.vendedor;

    _idController.text = vendedor.id.toString();
    _codigoController.text = vendedor.clave;
    _nombreController.text = vendedor.nombre;
    _currentEstatus = vendedor.activo==true?"ACTIVO":"INACTIVO";
...
//                                    prefixIcon: Icon(Icons.lock),
  ...
  gotoListaVendedores(){
    Navigator.pushAndRemoveUntil(context, new MaterialPageRoute(builder: (context) => ListaVendedores()),
...
//  }
  ...
  Future<void> actionButtonRaised() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => ListaVendedores(),
      ),
    );
...
//     setState(() {});
  ...
  saveRecord() async {
       ...
       vendedor.id = int.parse( _idController.text );
       vendedor.nombre= _nombreController.text;
       vendedor.activo = _currentEstatus=="ACTIVO"?true:false;
       vendedor.clave = _codigoController.text;

       await service.salvaOneVendedor(vendedor);
      actionButtonRaised();
